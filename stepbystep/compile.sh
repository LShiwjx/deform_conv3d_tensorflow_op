...
nvcc -std=c++11 -c -o deformable_conv3d_video2col.cu.o deformable_conv3d_video2col.cu.cc \
...
g++ -std=c++11 -shared -o deformable_conv3d_video2col.so deformable_conv3d_video2col.cc\
    deformable_conv3d_video2col.cu.o -I/home/sl/anaconda2/envs/tensorflow/lib/python3.4/site-packages/tensorflow/include \
