...
nvcc -std=c++11 -c -o deform_conv3d.cu.o deform_conv3d.cu.cc \
...
g++ -std=c++11 -shared -o deform_conv3d.so deform_conv3d.cc\
    deform_conv3d.cu.o -I/home/sl/anaconda2/envs/tensorflow/lib/python3.4/site-packages/tensorflow/include \
