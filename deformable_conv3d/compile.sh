...
nvcc -std=c++11 -c -o deformable_conv3d.cu.o deformable_conv3d.cu.cc \
...
g++ -std=c++11 -shared -o deformable_conv3d.so deformable_conv3d.cc\
    deformable_conv3d.cu.o -I/home/sl/anaconda2/envs/tensorflow/lib/python3.4/site-packages/tensorflow/include \
